...
getP1.addEventListener('click', () => {
    getData('http://localhost:4567/api/sveriges-radio/songs/132')
})

getP2.addEventListener('click', () => {
    getData('http://localhost:4567/api/sveriges-radio/songs/163')
})

getP3.addEventListener('click', () => {
    getData('http://localhost:4567/api/sveriges-radio/songs/164')
})

getP4.addEventListener('click', () => {
    getData('http://localhost:4567/api/sveriges-radio/songs/207')
})
...
getMyPlayList_1.addEventListener('click', () => {
    getPlayList('http://localhost:4567/api/spotify/myplaylists/10')
})
...
getMyLyrics.addEventListener('click', () => {
    ...
    getLyrics('http://localhost:4567/api/chartlyrics/getLyrics/' + artist + '/' + song)
})